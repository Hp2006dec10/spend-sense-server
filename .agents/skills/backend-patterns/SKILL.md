...
Refer to [api-patterns](../api-design/) while designing APIs.
...
Refer to [postgres-patterns](../postgres-patterns/) or [mysql-patterns](../mysql-patterns/) for respective database design patterns accordingly.
...
Refer to [error-handling](../error-handling/) for detailed explanation on error handling.
...
shape; use [api-design](../api-design/) for the HTTP contract.
